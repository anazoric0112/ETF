...
public class FactorDesignatorAct extends Factor {

    private DesignatorCall DesignatorCall;
    private ActPars ActPars;

    public FactorDesignatorAct (DesignatorCall DesignatorCall, ActPars ActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDesignatorAct(\n");
