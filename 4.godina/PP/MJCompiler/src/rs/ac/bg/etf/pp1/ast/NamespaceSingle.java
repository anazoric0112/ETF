...
public class NamespaceSingle implements SyntaxNode {
    ...
    public NamespaceSingle (NamespaceName NamespaceName, List List, MethodDeclList MethodDeclList) {
