...
public class ForAfterNotEmpty extends ForAfter {

    private ForDesignatorStatementList ForDesignatorStatementList;

    public ForAfterNotEmpty (ForDesignatorStatementList ForDesignatorStatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ForAfterNotEmpty(\n");
