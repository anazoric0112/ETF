...
public class StaticInitializerListMore extends StaticInitializerList {

    private StaticInitializerList StaticInitializerList;
    private StaticInitializer StaticInitializer;

    public StaticInitializerListMore (StaticInitializerList StaticInitializerList, StaticInitializer StaticInitializer) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StaticInitializerListMore(\n");
